#!/usr/bin/env python3
"""
Validate ranked export CSV structure.
...
def validate_submission(csv_path):
    ...
    if path.suffix.lower() != ".csv":
        ...
        errors.append("Filename must be a non-empty .csv file name.")
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python validate_submission.py <ranked_export.csv>")
        sys.exit(1)
